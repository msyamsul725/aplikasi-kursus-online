...
import '../../courses_list/view/courses_list_view.dart';
import '../controller/Profile_courses_controller.dart';

class ProfileCoursesView extends StatelessWidget {
  const ProfileCoursesView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ProfileCoursesController>(
      init: ProfileCoursesController(),
      builder: (controller) {
...
*/
        ...
        List<Map<String, dynamic>> card2 = [
          ...
          },
          {
            ...
            'onTap': () => Get.to(const CoursesListView())
          },
        ];
